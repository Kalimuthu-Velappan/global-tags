...
#define COMPACTXREF	" __.COMPACTXREF"
...
//KALS
void gtags_put_using(GTOP *, const char *, int, const char *, const char *, const char*);
void gtags_flush(void *, GTOP *, const char *);
